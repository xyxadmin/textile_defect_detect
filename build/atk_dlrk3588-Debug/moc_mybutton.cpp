...
QT_MOC_LITERAL(3, 23, 8), // "setState"
QT_MOC_LITERAL(4, 32, 6) // "status"

    },
    "MyButton\0stateChanged\0\0setState\0status"
};
...
void MyButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyButton::stateChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (MyButton::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyButton::setState)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void MyButton::stateChanged()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void MyButton::setState(bool _t1)
{
