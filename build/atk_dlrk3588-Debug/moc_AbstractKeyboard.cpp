...
#include <memory>
#include "../../../uitest/Keyboard/AbstractKeyboard.h"
...
void AeaQt::AbstractKeyboard::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<AbstractKeyboard *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (AbstractKeyboard::*)(int , QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AbstractKeyboard::keyPressed)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject AeaQt::AbstractKeyboard::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_AeaQt__AbstractKeyboard.data,
    qt_meta_data_AeaQt__AbstractKeyboard,
    qt_static_metacall,
    nullptr,
    nullptr
} };
