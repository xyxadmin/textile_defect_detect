...
#define OLED_SDIN_Clr() HAL_GPIO_WritePin(OLED_SDIN_PORT,OLED_SDIN_PIN,GPIO_PIN_RESET)//DIN
...
#define OLED_DC_Clr() HAL_GPIO_WritePin(OLED_RST_PORT,GPIO_PIN_1,GPIO_PIN_RESET)//RES
